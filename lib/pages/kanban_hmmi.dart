...
class KanbanHmmi extends StatefulWidget {
  @override
  _KanbanHmmiPageState createState() => _KanbanHmmiPageState();
}

class _KanbanHmmiPageState extends State<KanbanHmmi> {
  ...
  Future<void> _submitToApi(String idKanban, String idLabel) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://mspin.newarmada.biz/sto/combin-kanban/hmmi-kanban'),
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
          'Authorization': 'Bearer $token',
        },
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.of(context).push(
                                PageRouteBuilder(
                                  pageBuilder: (_, __, ___) => HistoryCombinKanban(sourcePage: "HMMI"),
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.of(context).push(
                                PageRouteBuilder(
                                  pageBuilder: (_, __, ___) => DnList(source: 'HMMI'),
                                  transitionsBuilder: (_, animation, __, child) {
                                    return SlideTransition(
                                      position: Tween<Offset>(
                                        begin: Offset(1, 0),
