...
class KanbanTmmin extends StatefulWidget {
  @override
  _KanbanTmminPageState createState() => _KanbanTmminPageState();
}

class _KanbanTmminPageState extends State<KanbanTmmin> {
  ...
  Future<void> _submitToApi(String idKanban, String idLabel) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://mspin.newarmada.biz/sto/combin-kanban/tmmin-kanban'),
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
          'Authorization': 'Bearer $token',
        },
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.of(context).push(
                                PageRouteBuilder(
                                  pageBuilder: (_, __, ___) => HistoryCombinKanban(sourcePage: "TMMIN"),
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.of(context).push(
                                PageRouteBuilder(
                                  pageBuilder: (_, __, ___) => DnList(source: 'TMMIN'),
                                  transitionsBuilder: (_, animation, __, child) {
                                    return SlideTransition(
                                      position: Tween<Offset>(
                                        begin: Offset(1, 0),
                        ...
                        children: List.generate(_historyKanban.length, (index) {
                          ...
                          return Container(
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Icon(Icons.qr_code_2, size: 28, color: Colors.teal),
                                SizedBox(width: 12),
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
